...
def test_payment_information_label_visibility():
    options = Options()
    ...
    try:
        ...
        assert payment_info_card.is_displayed(), "'Payment Information' label is not visible."
        ...
        print(str(e))
        driver.save_screenshot("C:\\Users\\Administrator\\Desktop\\QE_COE\\automated_pipeline_2\\captured_screenshots\\failed_case.png")
        sys.exit(1)
        
    finally:
        driver.quit()

test_payment_information_label_visibility()
